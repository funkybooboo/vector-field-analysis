...
| `fieldGenerator.hpp` / `fieldGenerator.cpp` | Generates a `Field::TimeSeries` from a `SimulatorConfig` |
| `fieldWriter.hpp` / `fieldWriter.cpp` | Writes a `Field::TimeSeries` to an HDF5 file |
